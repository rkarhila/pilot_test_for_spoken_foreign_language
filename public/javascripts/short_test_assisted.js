...
<p>Your user  code is <b>$username</b>. You can view your results later with this code.</p> \
...
<p>When you click the record button, you will see a bit of text from a dialogue. Read it aloud. You have a maximum of 15 seconds for each text.</p><div id=stimulus style=\"font-family: 'Arial Black', 'Arial';font-size: 52px;font-style: normal; font-variant: normal; font-weight: bold; line-height: 70.4px;\"></div></div>",
	"controls" :  "start_only",
	"evaluated": true,
	"stimulus_layout" : "<div class=main><h2>Finished! </h2><p><i>Ha det bra! Jättekiva fiilis!</i></p><p>That's it. Now let's wait for all the audio files to transfer and your results to be computed. It's a long wait because we are burdened with other work and could not spend time optimizing the code. Let's hope it works!</p></div>",
